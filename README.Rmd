...
password, there is no way to recover the contents of the file. Password encoding
was not extensively tested. Before encrypting with non ASCII characters, it is
recommended to check that files encoded this way, can be opened in spreadsheet
software.
